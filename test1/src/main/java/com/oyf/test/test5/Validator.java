...
/**
 * ConstraintsAnnotation注解 校验器 实现
 * <p>
 ...
 *     由于缓存的key是能唯一定位的， 且ConstraintValidator的实例属性
 *     只有在{@link ConstraintValidator#initialize}方法中才会写，在{@link ConstraintValidator#isValid}方法中只是读。
 *     所以不用担心线程安全问题。
 *
 * @author ouyangfei
 * @date Created in 2021/3/25
 */
public class Validator implements ConstraintValidator<Constraints, Object> {
